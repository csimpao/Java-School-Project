...
public class AudioBook extends AudioContent
{
									...
									String author, String narrator, ArrayList<String> chapterTitles, ArrayList<String> chapters)
	{
		...
		// Initializing other AudioBook Properties
		this.author = author;
  ...
  // Print information about the audiobook. First print the basic information of the AudioContent 
	...
	{
		// Printing the original info
		super.printInfo();
		// Also prints the author and the narrator
  ...
  // Play the audiobook by setting the audioFile to the current chapter title (from chapterTitles array list) 
	...
	public void play()
	{
		// Sets the AudioFile to the current chapter index of the chapter title, adds a space in between the lines, and it includes the text in that chapter
	...
	{
		// Loops through the chapter titles list and prints all the chapters in TOC
		for (int i = 0; i < chapterTitles.size(); i++) {
			// i+1 -  chapters always start at 1
	...
	public boolean equals(Object other)
	{
		...
		return author.equals(otherBook.author) && narrator.equals(otherBook.narrator);
	}
